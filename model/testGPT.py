...
from Tutor import ChatGPTTutor, GPT4Tutor
...
for question in data:
    mathtutor=GPT4Tutor(question["question"],question["final_ans"]) #if "type" in question and question["type"]=="Llama" else MathTutor(question["solutions"],question["incorrect_answer"])
